...
| `doc-ingest` | Produced doc/analysis/report → note in `06-knowledge/` + project links | No |
...
| `knowledge-build` | Personal wiki (encyclopedic pages, grown from the first mention) + distilled lessons in `06-knowledge/` | Weekly (lessons sweep) |
